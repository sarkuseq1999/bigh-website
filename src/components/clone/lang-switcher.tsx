...
export function LangSwitcher() {
  ...
  return (
    <label className="flex items-center gap-1.5 text-sm text-pine-soft">
      ...
      <select
        className="cursor-pointer appearance-none bg-transparent pr-1 font-medium text-pine outline-none"
        value={locale}
        onChange={(e) => {

...
const collection = [
  {
    name: "NuriCell",
    image: "nuricell",
    storyImage: "/images/products/stories/nuricell-coast-v1.webp",
    ...
    highlights: [
      ...
      { icon: Brain, label: "Mental energy" },
    ],
    tint: "#edf5fc",
    ink: "#24578e",
  },
  {
    ...
    storyImage: "/images/products/stories/propolis-v1.webp",
    ...
    detailIcon: Leaf,
    highlights: [
      { icon: MapPin, label: "Minas Gerais, Brazil" },
      { icon: Leaf, label: "Distinctive plant compounds" },
    ],
    tint: "#f2f5e9",
    ink: "#58682e",
  },
  {
    ...
    image: "advanced-opc",
    storyImage: "/images/products/stories/opc-v1.webp",
    ...
    detailIcon: Shield,
    highlights: [
      { icon: Leaf, label: "Plant-based antioxidants" },
      { icon: Shield, label: "Free-radical defenses" },
    ],
    tint: "#fcf0f1",
    ink: "#964758",
  },
  {
    name: "Turmerific",
    image: "turmerific",
    storyImage: "/images/products/stories/turmeric-v1.webp",
    ...
    detailIcon: Microscope,
    highlights: [
      { icon: Sun, label: "Longvida® curcumin" },
      { icon: FlaskConical, label: "Advanced delivery" },
    ],
    tint: "#fff4e5",
    ink: "#956123",
  },
  {
    name: "Nature Calm",
    image: "nature-calm",
    storyImage: "/images/products/stories/calm-v1.webp",
    ...
    highlights: [
      ...
      { icon: Waves, label: "Everyday stress" },
    ],
    tint: "#eef6ed",
    ink: "#487249",
  },
            ...
            >
              <span className={styles.visual}>
                ...
                <Image
                  ...
                  sizes={
                    index === 0
                      ? "(max-width: 760px) 360px, (max-width: 1100px) 32vw, 440px"
                      : "(max-width: 760px) 55vw, (max-width: 1100px) 25vw, 340px"
                  }
            ...
            >
              <div className={styles.storyHeading}>
                {selected === index && (
                  <Image
                    ...
                    alt=""
                    fill
                    sizes="(max-width: 760px) 100vw, (max-width: 1480px) 45vw, 615px"
              ...
              <div className={styles.storyCopy}>
                ...
                <ul className={styles.highlights}>
                  {item.highlights.map(({ icon: Icon, label }) => (
                    <li key={label}>
